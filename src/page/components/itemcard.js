...
function ItemCard({keyNumber,itemImageURL, itemBrandName, itemGoodsName, itemSalePrice, itemDeliveryText, itemDeliveryInfo, itemBuyCount}){
    return(
        <div className="component component--item_card" id={keyNumber}>
